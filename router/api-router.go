...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		// Subscription billing (global plan, user self-service)
		...
		{
			subscriptionAdminRoute.GET("/plan", controller.AdminGetGlobalSubscriptionPlan)
			subscriptionAdminRoute.PUT("/plan", controller.AdminUpdateGlobalSubscriptionPlan)
			subscriptionAdminRoute.POST("/bind_all", controller.AdminBindGlobalSubscriptionForAllUsers)
